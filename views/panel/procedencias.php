		...
		<div class="caja-min caja-form animatetop">
			<form id="form" method="post" enctype="multipart/form-data">
				...
				<div class="caja-form-header">
					...
					<h2><i class="fas fa-plane-departure"></i>Gestión de Procedencia</h2>
				</div>
				<div class="caja-form-section">
					<div class="caja-fila-inputs">
						<div class="caja-inputs">
							<label>Procedencia</label>
							<input type="text" id="procedencia" name="procedencia" onChange="this.value=(this.value).toUpperCase()" style="text-transform:uppercase" required>
						</div>
					</div>
				</div>
			...
			<div class="caja-scroll">
				<table id="tabla">
					<thead>
						<tr>
							<th><a>Opciones</a></th>
							<th><a href="Javascript:void()" onClick="w3.sortHTML('#tabla', '.fila', 'td:nth-child(2)')">Procedencia</a></th>
						</tr>
					</thead>
					<tbody></tbody>
				</table>
...
function tablear(){
	...
	$.ajax({
		url: "tables/procedencias_filas.php",
		type: "POST",
		dataType: "HTML",
	...
	$.ajax({
		url: "tables/procedencias_tabla.php",
		type: "POST",
		dataType: "HTML",
...
function editar(b){
	...
	$.ajax({
		url: "queries/info_procedencia.php",
		type: "POST",
		dataType: "JSON",
		data: {id: id}
	})
...
$("#form").on("submit", function(e){
	...
	$.ajax({
		url: "models/guardar_procedencia.php",
		type: "POST",
		dataType: "html",
		data: formData,
		cache: false,
