		...
		<div class="caja-min caja-form animatetop">
			<form id="form" method="post" enctype="multipart/form-data">
				...
				<div class="caja-form-header">
					...
					<h2><i class="fas fa-clock"></i>Gestión de Turno</h2>
				</div>
				<div class="caja-form-section">
					<div class="caja-fila-inputs">
						<div class="caja-inputs">
							<label>Turno</label>
							<input type="number" id="turno" name="turno" min="1" required>
						</div>
					</div>
				</div>
			...
			<div class="caja-scroll">
				<table id="tabla">
					<thead>
						<tr>
							<th><a>Opciones</a></th>
							<th><a href="Javascript:void()" onClick="w3.sortHTML('#tabla', '.fila', 'td:nth-child(2)')">Turno</a></th>
						</tr>
					</thead>
					<tbody></tbody>
				</table>
