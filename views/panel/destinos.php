		...
		<div class="caja-min caja-form animatetop">
			<form id="form" method="post" enctype="multipart/form-data">
				...
				<div class="caja-form-header">
					...
					<h2><i class="fas fa-plane-arrival"></i>Gestión de Destino</h2>
				</div>
				<div class="caja-form-section">
					<div class="caja-fila-inputs">
						<div class="caja-inputs">
							<label>Destino</label>
							<input type="text" id="destino" name="destino" onChange="this.value=(this.value).toUpperCase()" style="text-transform:uppercase" required>
						</div>
					</div>
				</div>
			...
			<div class="caja-scroll">
				<table id="tabla">
					<thead>
						<tr>
							<th><a>Opciones</a></th>
							<th><a href="Javascript:void()" onClick="w3.sortHTML('#tabla', '.fila', 'td:nth-child(2)')">Destino</a></th>
						</tr>
					</thead>
					<tbody></tbody>
				</table>
...
$("#form").on("submit", function(e){
	...
	$.ajax({
		url: "models/guardar_destino.php",
		type: "POST",
		dataType: "html",
		data: formData,
		cache: false,
